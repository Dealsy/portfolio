              ...
              <div className="grid grid-cols-1 gap-4 lg:col-span-2 shadow">
                <section aria-labelledby="section-1-title">
                  ...
                  <div className="rounded-lg bg-white overflow-hidden shadow">
                    ...
                    <div className="bg-indigo-600">Projects</div>
                  </div>
                </section>
              </div>

              {/* Right column */}
              <div className="grid grid-cols-1 gap-4 shadow">
                  ...
                  <div className="rounded-lg bg-white overflow-hidden shadow">
                    <div className="p-6 flex flex-col justify-center">
                      ...
                      <ul className="border border-gray-300 p-2">
                        ...
                        <li className="border-b border-gray-300 hover:bg-gray-300">
                          Creating a Search and A-Z filter in NEXT JS
                        </li>
                        <li className="backdrop:border-b border-gray-300 hover:bg-gray-300">
                          How to display API objects to your webpage in React
                        </li>
                      </ul>
                    </div>
                  </div>
